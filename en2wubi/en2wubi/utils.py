...
def save_dict(target_dict, filename, save_path=e2w.E2W_PACKAGE_DICT_PATH):
...
def load_ch_wubi_dict(dict_path=e2w.E2W_CH_WUBI_PATH):
    ...
    dict_path : str
        ...
        In default, it's E2W_CH_WUBI_PATH.
...
def load_wubi_ch_dict(dict_path=e2w.E2W_WUBI_CH_PATH):
    ...
    dict_path : str
        the absolute path to chinese2wubi dictionary.
        In default, it's E2W_WUBI_CH_PATH.
...
def convert_line(in_line, map_dict, line_type):
    ...
    """
    if line_type == "ch":
        in_line = in_line.translate(e2w.CH2EN_PUNC)
        ...
        return out_line.translate(e2w.EN2CH_PUNC)
